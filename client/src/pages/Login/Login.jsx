  ...
  return (
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-3 py-2.5 bg-white/5 border border-white/10 rounded-lg text-[var(--text)] placeholder-[var(--text-dim)] focus:outline-none focus:border-[var(--accent-2)] focus:ring-1 focus:ring-[var(--accent-2)] transition"
          />
        </div>
        <div>
          <label className="block text-xs font-mono text-[var(--text-dim)] mb-1.5 tracking-wide">
      ...
      <p className="text-sm text-[var(--text-dim)] mt-6 text-center">
        ...
        <Link to="/signup" className="text-[var(--accent-2)] font-medium hover:underline">
          Sign up
        </Link>
      </p>
    </AuthLayout>
